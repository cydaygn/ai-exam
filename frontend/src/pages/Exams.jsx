      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {exams.map(exam => {
          ...
          return (
            ...
            >
              <h2
                className={`text-xl font-semibold mb-2 flex items-center gap-2 break-words ${st.iconColor}`}
              >
