...
function AdminStudents() {
  ...
  return (
    <div className="w-full bg-gradient-to-b from-slate-50 via-cyan-50 to-emerald-50 font-sans text-slate-900 relative">
      ...
      {/* topbar */}
      <nav className="flex items-center justify-between px-8 md:px-12 py-5 bg-white/65 backdrop-blur-xl border-b border-slate-900/10">
        <button
          type="button"
      ...
      <main className="px-6 md:px-10 lg:px-16 py-10 md:py-12 space-y-6">
        {/* header */}
        <div>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <DetailRow
                label="Plan"
                value={
                  <span className={`inline-flex px-3 py-1 rounded-full text-sm font-extrabold border ${
                    selectedStudent.plan === 'plus'
                      ? 'bg-yellow-100 border-yellow-200 text-yellow-800'
                      : 'bg-slate-100 border-slate-200 text-slate-700'
                  }`}>
                    {selectedStudent.plan === 'plus' ? '⭐ Plus' : 'Free'}
                  </span>
                }
              />
              <DetailRow
