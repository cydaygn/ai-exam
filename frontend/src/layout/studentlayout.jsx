...
function StudentLayout() {
  ...
  const [desktopSidebarOpen, setDesktopSidebarOpen] = useState(false); // desktop overlay sidebar
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-slate-50 via-cyan-50 to-emerald-50 font-sans text-slate-900 relative overflow-x-hidden">
      ...
      <div className="relative z-10 flex min-h-screen">
        {/* DESKTOP OVERLAY (sidebar açıkken arkaplan) */}
        {desktopSidebarOpen && (
          <div
        ...
        {/* DESKTOP: kapalıyken üç nokta butonu */}
<button
  ...
  className={[
    ...
    desktopSidebarOpen ? "opacity-0 pointer-events-none" : "opacity-100",
  ].join(" ")}
>
  <svg
    width="22"
  ...
  >
    ...
    <line x1="5" y1="17" x2="19" y2="17" />
        ...
        {/* DESKTOP SIDEBAR - Overlay (ekran kaymaz) */}
        <aside
          className={[
